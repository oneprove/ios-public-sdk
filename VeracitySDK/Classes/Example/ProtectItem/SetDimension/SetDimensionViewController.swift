...
protocol SetDimensionPresentableListener: AnyObject {
    func confirmedDimension(width: String, height: String, name: String?)
}

protocol SetDimensionViewControllerDelegate: AnyObject {
...
final class SetDimensionViewController: UIViewController, SetDimensionPresentable, KeyboardAnimationProtocol {
    ...
    init(createItemStream: MutableProtectItemStream) {
        ...
        let bundle = Bundle(for: SetDimensionViewController.self)
        super.init(nibName: "SetDimensionViewController", bundle: bundle)
    }
