...
protocol TakeFingerprintARViewDelegate: class {
...
class TakeFingerprintARView: UIView {
    ...
    private func setup() {
        Bundle.main.loadNibNamed("TakeFingerprintARView", owner: self, options: nil)
    ...
    private func showPoitingGuideView() {
        let poitingGuideView = UIImageView(image: #imageLiteral(resourceName: "ar_pointing_onboard"))
    ...
    private func showGuidingAreaFrame() {
        ...
        let guidingAreaView = UIImageView(image: #imageLiteral(resourceName: "ar_pointing_area"))
